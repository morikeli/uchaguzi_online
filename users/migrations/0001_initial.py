    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aspirant_school', models.CharField(max_length=70)),
                ('has_nominated', models.BooleanField(default=False)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('aspirant_name', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='users.aspirants')),
